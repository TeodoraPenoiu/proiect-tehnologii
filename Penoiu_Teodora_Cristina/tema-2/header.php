        ...
        <nav class="nav nav-masthead float-md-end">
            ...
            <div class="pl-2 dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="../tema-1/B/participanti.html">Participanti</a></li>
                    <li><a class="dropdown-item" href="login.html">Intra in cont</a></li>
                    <li><a class="dropdown-item" href="inscriere.html">Inscriete-te!</a></li>
                </ul>
            </div>
        </nav>
    </div>
